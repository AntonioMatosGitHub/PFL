...
import Data.List
import System.IO
import Norm (parsePol, removeZero, multPols)
...
p6 = [(3,[('x',1),(' ',1)]),(1,[(' ',1),('4',1),('x',1),(' ',1)]),(-1,[(' ',1),('2',1),('y',1),(' ',1)]),(1,[(' ',1),('y',1),(' ',1)]),(1,[(' ',1),('2',1),('x',2),(' ',1)]),(-1,[(' ',1),('x',2)])]
...
gui = do
  ...
  if option == "1" then 
    ...
    do putStr "Escreva 1º polinomio da soma:\n"
       ...
       putStr ( (parsePol $ addPols poli poli2) ++ "\n")
    ...
    do putStr "Escreva 1º polinomio da multiplicaçao:\n"
       ...
       let poli = readPolynomial $ removeWhiteSpace poliStr
       let poli2 = readPolynomial $ removeWhiteSpace poliStr2
       putStr ( (parsePol $ multPols poli poli2) ++ "\n")
  else 
    do putStr "Escreva polinomio a derivar:\n"
       ...
       ordem <- getChar
       let poli = readPolynomial $ removeWhiteSpace poliStr
       putStr ( (parsePol $ derivatePol ordem poli) ++ "\n")


main = do
  print ("polinomio com zeros ", (parsePol . removeZero ) (p5) ==("2a"))
  print ("polinomio com somas internas ", (parsePol . normalize  ) (p1) ==("3 + 8a + b^4"))
  print ("polinomio desordenado", (parsePol . sortPol   ) (p3) ==("2*b^2*a^3 + 3c"))
  print ("variavais desordenado", (parsePol . normalize ) (p3) ==("2*a^3*b^2 + 3c"))
  print ("converter variavel com expoente 0 em 1", (parsePol . fixExpZero  ) (p1) ==("3 + 2a + b^4 + 6a"))
  print ("nomalizar polinomio grade", (parsePol . normalize ) (p7) ==("6 + 10a + b^4"))
  print ("nomalizar polinomio grade", (parsePol . normalize ) (p8) ==("6 + 18a + 2b^4"))
  print ("somar 2 polinomios", (parsePol $ addPols p2 p1) ==("6 + 8a + 4a^3 + b^4"))
  print ("multiplicar 2 polinomios", (parsePol $ multPols p2 p1  ) ==("2a"))
  print ("derivar", (parsePol $ derivatePol 'a' p5) ==("2"))
